...
- If a shared package is ever needed across apps (for example a common UI kit or API client), add it under a `packages/` directory in this same repo. Do not create a separate repository or a second workspace for it.
