...
- R5 Dormant hook resolution (D2): `verify-before-finish.ps1` is either wired to a config.toml event and covered by Test-HookReferences and test-hooks, or deleted with its required-path entries removed. Decision recorded in this spec on execution.
